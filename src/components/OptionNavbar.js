          ...
          <li class={styles.navItem}>
            <Link className={styles.navLink} to="/Sport">
              <svg
                ...
                className="svg-inline--fa fa-volleyball"
                role="img"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
              >
              ...
              <span className={styles.linkText}>Sport</span>
            </Link>
          </li>
        )}
          ...
          <li className={styles.navItem}>
            <Link className={styles.navLink} to="Party">
              <svg
                ...
                className="svg-inline--fa fa-champagne-glasses"
                role="img"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 640 512"
              >
              ...
              <span className={styles.linkText}>Party</span>
            </Link>
          </li>
        )}
        {window.location.pathname !== "/Study" && (
          <li className={styles.navItem}>
            <Link className={styles.navLink} to="Study">
              ...
              <span className={styles.linkText}>study</span>
            </Link>
          </li>
        )}
          ...
          <li className={styles.navItem}>
            <Link className={styles.navLink} to="Adventure">
              <svg
                ...
                data-prefix="fas"
                data-icon="mountain"
                className="svg-inline--fa fa-mountain"
                role="img"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
              >
              ...
              <span className={styles.linkText}>Adventure</span>
            </Link>
          </li>
        )}
